...
static void w2c___wasm_call_ctors(Z_add_instance_t*);
static u32 w2c_add(Z_add_instance_t*, u32, u32);
static u32 w2c___errno_location(Z_add_instance_t*);
static void w2c_f3(Z_add_instance_t*, u32);
static u32 w2c_f4(Z_add_instance_t*);
static void w2c_emscripten_stack_init(Z_add_instance_t*);
static u32 w2c_emscripten_stack_get_free(Z_add_instance_t*);
static u32 w2c_emscripten_stack_get_base(Z_add_instance_t*);
static u32 w2c_emscripten_stack_get_end(Z_add_instance_t*);
static void w2c_f9(Z_add_instance_t*, u32);
static void w2c_f10(Z_add_instance_t*, u32);
static u32 w2c_f11(Z_add_instance_t*);
static void w2c_f12(Z_add_instance_t*);
static u32 w2c_f13(Z_add_instance_t*, u32);
static void w2c_f14(Z_add_instance_t*, u32);
static u32 w2c_fflush(Z_add_instance_t*, u32);
static u32 w2c_stackSave(Z_add_instance_t*);
static void w2c_stackRestore(Z_add_instance_t*, u32);
static u32 w2c_stackAlloc(Z_add_instance_t*, u32);
static u32 w2c_emscripten_stack_get_current(Z_add_instance_t*);

static void init_globals(Z_add_instance_t* instance) {
...
static void init_memories(Z_add_instance_t* instance) {
  wasm_rt_allocate_memory(&instance->w2c_memory, 256, 256);
}

static void init_tables(Z_add_instance_t* instance) {
  wasm_rt_allocate_funcref_table(&instance->w2c___indirect_function_table, 1, 1);
}

static void w2c___wasm_call_ctors(Z_add_instance_t* instance) {
  FUNC_PROLOGUE;
  w2c_emscripten_stack_init(instance);
  FUNC_EPILOGUE;
}

static u32 w2c_add(Z_add_instance_t* instance, u32 w2c_p0, u32 w2c_p1) {
...
static u32 w2c___errno_location(Z_add_instance_t* instance) {
  FUNC_PROLOGUE;
  u32 w2c_i0;
  w2c_i0 = 65536u;
  FUNC_EPILOGUE;
...
static void w2c_f3(Z_add_instance_t* instance, u32 w2c_p0) {
  FUNC_PROLOGUE;
  u32 w2c_i0;
  w2c_i0 = w2c_p0;
...
static u32 w2c_f4(Z_add_instance_t* instance) {
  FUNC_PROLOGUE;
  u32 w2c_i0;
...
static void w2c_emscripten_stack_init(Z_add_instance_t* instance) {
  FUNC_PROLOGUE;
  u32 w2c_i0, w2c_i1;
  w2c_i0 = 65536u;
...
static u32 w2c_emscripten_stack_get_free(Z_add_instance_t* instance) {
  FUNC_PROLOGUE;
  u32 w2c_i0, w2c_i1;
  w2c_i0 = instance->w2c_g0;
...
static u32 w2c_emscripten_stack_get_base(Z_add_instance_t* instance) {
  FUNC_PROLOGUE;
  u32 w2c_i0;
...
static u32 w2c_emscripten_stack_get_end(Z_add_instance_t* instance) {
  FUNC_PROLOGUE;
  u32 w2c_i0;
...
static void w2c_f9(Z_add_instance_t* instance, u32 w2c_p0) {
  FUNC_PROLOGUE;
  FUNC_EPILOGUE;
}

static void w2c_f10(Z_add_instance_t* instance, u32 w2c_p0) {
  FUNC_PROLOGUE;
  FUNC_EPILOGUE;
}

static u32 w2c_f11(Z_add_instance_t* instance) {
  FUNC_PROLOGUE;
  u32 w2c_i0;
  w2c_i0 = 65540u;
...
static void w2c_f12(Z_add_instance_t* instance) {
  FUNC_PROLOGUE;
  u32 w2c_i0;
  w2c_i0 = 65540u;
...
static u32 w2c_f13(Z_add_instance_t* instance, u32 w2c_p0) {
  FUNC_PROLOGUE;
  u32 w2c_i0;
  w2c_i0 = 1u;
  FUNC_EPILOGUE;
...
static void w2c_f14(Z_add_instance_t* instance, u32 w2c_p0) {
  FUNC_PROLOGUE;
  FUNC_EPILOGUE;
}

static u32 w2c_fflush(Z_add_instance_t* instance, u32 w2c_p0) {
  ...
  w2c_l1 = w2c_i0;
  w2c_i0 = 0u;
  w2c_i0 = i32_load(&instance->w2c_memory, (u64)(w2c_i0) + 65548u);
  w2c_i0 = !(w2c_i0);
  ...
  w2c_L4: 
    ...
    w2c_i0 = w2c_p0;
    w2c_i0 = w2c_f13(instance, w2c_i0);
    w2c_l2 = w2c_i0;
    w2c_B5:;
    w2c_i0 = w2c_p0;
  ...
  w2c_i0 = CALL_INDIRECT(instance->w2c___indirect_function_table, u32 (*)(void*, u32, u32, u32), 5, w2c_i3, instance->w2c___indirect_function_table.data[w2c_i3].module_instance, w2c_i0, w2c_i1, w2c_i2);
  w2c_i0 = w2c_p0;
  w2c_i0 = i32_load(&instance->w2c_memory, (u64)(w2c_i0) + 20u);
  if (w2c_i0) {goto w2c_B11;}
  w2c_i0 = 4294967295u;
  ...
  w2c_j0 = CALL_INDIRECT(instance->w2c___indirect_function_table, u64 (*)(void*, u32, u64, u32), 6, w2c_i3, instance->w2c___indirect_function_table.data[w2c_i3].module_instance, w2c_i0, w2c_j1, w2c_i2);
  w2c_B12:;
  w2c_i0 = 0u;
  w2c_l1 = w2c_i0;
  w2c_i0 = w2c_p0;
...
static u32 w2c_stackSave(Z_add_instance_t* instance) {
  FUNC_PROLOGUE;
  u32 w2c_i0;
  w2c_i0 = instance->w2c_g0;
  FUNC_EPILOGUE;
...
static void w2c_stackRestore(Z_add_instance_t* instance, u32 w2c_p0) {
  FUNC_PROLOGUE;
  u32 w2c_i0;
  w2c_i0 = w2c_p0;
...
static u32 w2c_stackAlloc(Z_add_instance_t* instance, u32 w2c_p0) {
...
static u32 w2c_emscripten_stack_get_current(Z_add_instance_t* instance) {
  FUNC_PROLOGUE;
  u32 w2c_i0;
  w2c_i0 = instance->w2c_g0;
  FUNC_EPILOGUE;
...
void Z_addZ___wasm_call_ctors(Z_add_instance_t* instance) {
  return w2c___wasm_call_ctors(instance);
}

/* export: 'add' */
u32 Z_addZ_add(Z_add_instance_t* instance, u32 w2c_p0, u32 w2c_p1) {
...
u32 Z_addZ___errno_location(Z_add_instance_t* instance) {
  return w2c___errno_location(instance);
}

/* export: 'fflush' */
u32 Z_addZ_fflush(Z_add_instance_t* instance, u32 w2c_p0) {
  return w2c_fflush(instance, w2c_p0);
}

/* export: 'emscripten_stack_init' */
void Z_addZ_emscripten_stack_init(Z_add_instance_t* instance) {
  return w2c_emscripten_stack_init(instance);
}

/* export: 'emscripten_stack_get_free' */
u32 Z_addZ_emscripten_stack_get_free(Z_add_instance_t* instance) {
  return w2c_emscripten_stack_get_free(instance);
}

/* export: 'emscripten_stack_get_base' */
u32 Z_addZ_emscripten_stack_get_base(Z_add_instance_t* instance) {
  return w2c_emscripten_stack_get_base(instance);
}

/* export: 'emscripten_stack_get_end' */
u32 Z_addZ_emscripten_stack_get_end(Z_add_instance_t* instance) {
  return w2c_emscripten_stack_get_end(instance);
}

/* export: 'stackSave' */
u32 Z_addZ_stackSave(Z_add_instance_t* instance) {
  return w2c_stackSave(instance);
}

/* export: 'stackRestore' */
void Z_addZ_stackRestore(Z_add_instance_t* instance, u32 w2c_p0) {
  return w2c_stackRestore(instance, w2c_p0);
}

/* export: 'stackAlloc' */
u32 Z_addZ_stackAlloc(Z_add_instance_t* instance, u32 w2c_p0) {
  return w2c_stackAlloc(instance, w2c_p0);
}

/* export: 'emscripten_stack_get_current' */
u32 Z_addZ_emscripten_stack_get_current(Z_add_instance_t* instance) {
...
void Z_add_instantiate(Z_add_instance_t* instance) {
  assert(wasm_rt_is_initialized());
...
void Z_add_free(Z_add_instance_t* instance) {
